(() => {
  ...
  // ../../../packages/transport-android/dist/webview-transport.js
  var DEFAULT_INTERFACE_NAME = "RpcBridge";
  var DEFAULT_CALLBACK_NAME = "__rpcBridgeReceive";
  var AndroidWebViewTransport = class extends MessageTransportBase {
    interfaceName;
    callbackName;
    constructor(options = {}) {
      ...
      if (!bridge || typeof bridge.sendFrame !== "function") {
        this.logger.warn(`Android bridge interface '${this.interfaceName}' not found. Messages will fail until the native side injects the interface.`);
      }
    }
    sendRaw(data) {
  ...
  // src/bootstrap.ts
  var transport = new AndroidWebViewTransport({
